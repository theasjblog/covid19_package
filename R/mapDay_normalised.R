...
#' @param chosenDay (numeric): the day to plot
#' @return a ggplot
doMapData_normalised <- function(plotData, filterByCountry = NULL,
                          plotMetric = 'cases',
                          chosenDay = NULL){
  world <- getMapData_normalised(plotData, filterByCountry, plotMetric, chosenDay)
  
  plotTitle <- paste0(plotMetric, ' on day ',
