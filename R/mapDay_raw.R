...
getMapData_raw <- function(plotData, filterByCountry = NULL, 
                                   plotMetric = 'cases',
                                   chosenDay = NULL){
...
#' @param chosenDay (numeric): the day to plot
#' @return a ggplot
doMapData_raw <- function(plotData, filterByCountry = NULL,
                                  plotMetric = 'cases',
                                  chosenDay = NULL){
  world <- getMapData_raw(plotData, filterByCountry, plotMetric, chosenDay)
  
  plotTitle <- paste0(plotMetric, ' on day ', unique(world$variable))
