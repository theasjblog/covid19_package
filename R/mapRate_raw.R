...
getMapDataRate_raw <- function(plotData, filterByCountry = NULL, 
                           plotMetric = 'cases',
                           chosenDay = NULL){
...
#' @param chosenDay (numeric): the day to plot
#' @return a ggplot
doMapDataRate_raw <- function(plotData, filterByCountry = NULL,
                          plotMetric = 'cases',
                          chosenDay = NULL){
  world <- getMapDataRate_raw(plotData, filterByCountry, plotMetric, chosenDay)
  
  plotTitle <- paste0('New ', plotMetric, ' on day ', unique(world$variable))
