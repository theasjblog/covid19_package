...
```{r getNewData}
refreshJHU()
fromDir <- here::here('vignettes', 'COVID-19-master')
toDir <- here::here('COVID-19-master')
moveF <- file.move(fromDir,toDir)
newData <- getJHU()
```
...
```{r mapPlots}
world <- getWorld(plotData = newData,
                        filterByCountry = c('Canada', 'Italy', 'Spain', 'Brazil'),
                        plotMetric = 'cases', chosenDay = NULL,
                        plotType = 'doMapTrend_normalise')
plotMap(world)
print(getMapTitle(world,
                        plotMetric = 'cases', chosenDay = NULL,
                        plotType = 'doMapTrend_normalise'))
...
world <- getWorld(plotData = newData,
                        filterByCountry = c('Canada', 'Italy', 'Spain', 'Brazil'),
                        plotMetric = 'cases', chosenDay = NULL,
                        plotType = 'doMapDataRate_normalised')
plotMap(world)
print(getMapTitle(world,
                        plotMetric = 'cases', chosenDay = NULL,
                        plotType = 'doMapDataRate_normalised'))
